 ...
 */
export const trackLandingCtaClick = (location: string = 'landing_cta_click') => {
  trackEvent('landing_cta_click', {
    click_location: location,
    event_category: 'engagement',
    event_label: 'landing_cta_click',
  });
};

/**
 * 랜딩페이지 로그인 버튼 클릭 추적 (하단)
 * @param location - 클릭 위치
 */
export const trackLandingLoginLinkClick = (location: string = 'landing_login_link_click') => {
  trackEvent('landing_login_link_click', {
    click_location: location,
    event_category: 'engagement',
    event_label: 'landing_login_link_click',
  });
};
 ...
 * @param location - 클릭 위치
 */
export const trackLandingBackButtonClick = (location: string = 'landing_back_button_click') => {
  trackEvent('landing_back_button_click', {
    click_location: location,
    event_category: 'engagement',
    event_label: 'landing_back_button_click',
  });
};
 ...
 * @param location - 클릭 위치
 */
export const trackKakaoLoginClick = (location: string = 'kakao_oauth_login') => {
